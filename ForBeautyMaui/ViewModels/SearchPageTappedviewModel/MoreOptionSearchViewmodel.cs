...
{
	public class MoreOptionSearchViewmodel : INotifyPropertyChanged
	{
        public event PropertyChangedEventHandler PropertyChanged;
        private DetailViewProductSearchViewModel _DetailViewProductHomePageViewModel;
        ...
        public MoreOptionSearchViewmodel(ObservableCollection<OtherDesginProduct> MoreProduct, string MoreOptionCount, DetailViewProductSearchViewModel detailViewModel)
        {
